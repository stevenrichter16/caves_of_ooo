...
public class SnapjawHero1 : IObjectBuilder
{
	public override void Apply(GameObject GO, string Context)
	{
		...
		GO.ReceiveObjectFromPopulation("Melee Weapons 2", null, NoStack: false, 25, 0, null, null, null, Context);
		GO.ReceiveObjectFromPopulation("Armor 2", null, NoStack: false, 25, 0, null, null, null, Context);
