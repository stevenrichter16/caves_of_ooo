...
[ExecuteAlways]
public class ParticleVFXThrow : MonoBehaviour, CombatJuice.ICombatJuiceConfigurable
{
	...
	private void Update()
	{
		...
		base.gameObject.transform.position += new Vector3(0f, Mathf.Sin(t / duration * MathF.PI) * 16f, 0f);
