...
public class RefractLight : IPart
{
	...
	{
		RefractLight refractLight = Part as RefractLight;
	...
	{
		if (!base.WantEvent(ID, cascade) && ID != EquippedEvent.ID && (ID != GetShortDescriptionEvent.ID || !ShowInShortDescription))
		{
	...
	public override bool FireEvent(Event E)
	{
		...
		{
			PlayWorldSound("sfx_light_refract");
