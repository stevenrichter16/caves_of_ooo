...
public class Shading : IPart
{
	...
	public override bool HandleEvent(GetShortDescriptionEvent E)
	{
		if (Amount != 1f)
		{
			...
			E.Postfix.AppendRules("Severity of heating effects reduced by " + text + ". Heat damage reduced by " + text + ".");
		}
	...
	{
		if ((E.Object == ParentObject.Equipped || E.Object == ParentObject) && E.Damage.IsHeatDamage())
		{
