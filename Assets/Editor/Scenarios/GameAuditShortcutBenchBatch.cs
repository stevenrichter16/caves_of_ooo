...
namespace CavesOfOoo.Editor
{
    ...
    [InitializeOnLoad]
    public static class GameAuditShortcutBenchBatch
    {
        private const string Prefix = "FLOW3.NativeBench.";
        static GameAuditShortcutBenchBatch() { if (SessionState.GetBool(Prefix + "active", false)) Subscribe(); }

        [MenuItem("Caves Of Ooo/Scenarios/Items/Shortcut Audit")]
        private static void Launch()
        {
            if (EditorSceneManager.SaveCurrentModifiedScenesIfUserWantsTo()) RunCore(false);
        }
        [MenuItem("Caves Of Ooo/Scenarios/Items/Shortcut Audit", true)]
        ...
        {
            string id = "FLOW3-bench-" + Guid.NewGuid().ToString("N");
        ...
        private static void Poll()
        {
            ...
            { Debug.LogError("[GameAuditShortcutBench] Native Play timed out before a complete audit and capture."); Finish(2); }
        }
        ...
        private static void Finish(int code)
        {
            ...
            Debug.Log("[GameAuditShortcutBench] Native capture exit=" + code);
