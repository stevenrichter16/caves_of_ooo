...
namespace CavesOfOoo.Rendering
{
    ...
    public class EnvironmentSpriteRenderer : MonoBehaviour
    {
        ...
        public static readonly (string Blueprint, string File)[] FixtureSprites =
        {
            ...
            ("LibraryTepuiboneWall", "library_tepuibone_wall"),
            ("LibraryMemoryMarbleWall", "library_memory_marble_wall"),
            ("LibraryChoirIronWall", "library_choir_iron_wall"),
            ("SealedLibraryFloor", "sealed_library_floor"),
            ("SealedArchiveShelf", "sealed_archive_shelf"),
            ("SealedLibraryDoor", "sealed_library_door"),
            ...
            new Dictionary<string, int>
        {
            ...
            { "TepuiboneVein", 4 },
            { "FoundingPlume", 4 },
            { "LibraryTepuiboneWall", 4 },
            { "LibraryMemoryMarbleWall", 4 },
            { "LibraryChoirIronWall", 4 },
            { "SealedLibraryFloor", 4 },
            { "SealedArchiveShelf", 4 },
