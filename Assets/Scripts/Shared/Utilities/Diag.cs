...
namespace CavesOfOoo.Diagnostics
{
    ...
    public static class Diag
    {
        ...
        private static readonly string[] DefaultOnCategories =
            { "event", "effect", "damage", "turn", "furniture", "trade", "quest", "skill", "enhancement", "mineral-trade", "worldmap", "liquid", "gas", "gasbench", "questbench", "alchemy", "craft", "crop", "loot", "worldgen", "spell", "tile" };
