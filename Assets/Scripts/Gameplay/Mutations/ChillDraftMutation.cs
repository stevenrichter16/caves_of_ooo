...
{
    public class ChillDraftMutation : BaseMutation
    {
        public const string COMMAND = "CommandChillDraft";
        public const int COOLDOWN = 5;
        public const int RADIUS = 1;

        public override string Name => "Chill Draft";
        public override string MutationType => "Mental";
        public override string DisplayName => "Chill Draft";
            ...
            for (int y = minY; y <= maxY; y++)
            {
                for (int x = minX; x <= maxX; x++)
                {
                    ...
                    for (int i = cell.Objects.Count - 1; i >= 0; i--)
                    {
                        ...
                        coolEvent.SetParameter("Joules", (object)(-100f));
