...
{
    public sealed class WorkshopBogRenderingTests
    {
        ...
        [TestCase("Overworld.6.6.0")] [TestCase("Overworld.15.6.0")]
        ...
        [TestCase("Overworld.6.6.1")] [TestCase("Overworld.15.6.1")]
        [TestCase("Overworld.5.17.1")] [TestCase("Overworld.12.3.2")]
        [TestCase("Overworld.06.6.0")] [TestCase("Overworld.15.06.0")]
        ...
        [TestCase("Overworld.6.6.0","MarketStall","cinderhold-stall-")]
        [TestCase("Overworld.15.6.0","MarketStall","cinderhold-stall-")]
        [TestCase("Overworld.6.6.0","RoadStone","cinderhold-path-")]
        [TestCase("Overworld.15.6.0","WaterPuddle","sumphold-water-")]
        [TestCase("Overworld.6.6.0","ConcordFactor","cinderhold-factor-")]
        [TestCase("Overworld.6.6.0","CinderholdNoticeBoard","cinderhold-notice-")]
        [TestCase("Overworld.6.6.0","TinkersForge","cinderhold-forge-")]
        [TestCase("Overworld.6.6.0","SmithAnvil","cinderhold-anvil-")]
        [TestCase("Overworld.6.6.0","Weaponsmith","cinderhold-smith-")]
        [TestCase("Overworld.15.6.0","BoatFrame","sumphold-hull-")]
        [TestCase("Overworld.15.6.0","TollRolls","sumphold-rolls-")]
        [TestCase("Overworld.15.6.0","PeatCutter","sumphold-cutter-")]
        ...
        { yield return "Overworld.6.6.0";yield return "Overworld.15.6.0"; }
    }
}
