...
namespace CavesOfOoo.Tests
{
    ...
    public sealed class MultiCellPilotNativeReportTests
    {
        const string Run="1aaad6c4ac50415c9b4cb43b642c37cf",Root="/tmp/private-pilot-report-fixture";
        ...
        {
            var type=AppDomain.CurrentDomain.GetAssemblies().Select(a=>a.GetType("CavesOfOoo.Editor.MultiCellPilotNativeAuditBatch")).FirstOrDefault(t=>t!=null);
        ...
        public void OneBrokenEvidenceInvariantCannotBeReportedAsComplete(string mutation)
        {
        ...
        {public string runId,saveRoot;public int worldSeed,screenWidth,screenHeight,nativeSteps,failures,unexpectedErrors;
         ...
         public Check[] checks;public Profile profile;}
