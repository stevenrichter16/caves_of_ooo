...
{
    public sealed class FoundingCampRenderingTests
    {
        ...
        public void StateReactiveNativePopulationAlsoHasVoxelCoverage(bool urquActive)
        {
            ...
            try
            {
                ...
                EveryVisibleNativeOwnerAcrossFourChunksHasAReadOnlyModel(64);
            }
            finally{NarrativeStatePart.Current=prior;}
        }

        [TestCase("Overworld.4.6.0")] [TestCase("Overworld.4.6.1")] [TestCase("Overworld.4.6.2")]
        [TestCase("Overworld.8.16.0")]
        public void TheFourNativeChunksBindVoxelPresentationWithoutUnmappedSources(string id)
        {
        ...
        [TestCase("Overworld.4.6.3")] [TestCase("Overworld.8.16.1")]
        [TestCase("Overworld.5.17.0")] [TestCase("Overworld.12.3.2")]
        [TestCase("Overworld.04.6.2")] [TestCase("Overworld.8.016.0")]
        ...
        public void EveryVisibleNativeOwnerAcrossFourChunksHasAReadOnlyModel(int seed)
        {
            ...
            Assert.AreEqual(4,count);Assert.IsEmpty(missing,string.Join("\n",missing));
        }

        [TestCase("Overworld.4.6.2","TheRooted","olderdeep-rooted-")]
        [TestCase("Overworld.4.6.2","FoundingPlume","olderdeep-plume-")]
        [TestCase("Overworld.4.6.2","NicheHome","olderdeep-niche-")]
        [TestCase("Overworld.4.6.2","PlaqueOldest","olderdeep-oldest-")]
        [TestCase("Overworld.8.16.0","TentWall","wellmeet-tent-")]
        [TestCase("Overworld.8.16.0","GuestClothPole","wellmeet-cloth-")]
        [TestCase("Overworld.8.16.0","TentRightHost","wellmeet-host-")]
        [TestCase("Overworld.8.16.0","SaltMaster","wellmeet-salt-")]
        ...
        [TestCase("Overworld.4.6.2")] [TestCase("Overworld.8.16.0")]
        ...
        { yield return "Overworld.4.6.0";yield return "Overworld.4.6.1";yield return "Overworld.4.6.2";yield return "Overworld.8.16.0"; }
    }
}
