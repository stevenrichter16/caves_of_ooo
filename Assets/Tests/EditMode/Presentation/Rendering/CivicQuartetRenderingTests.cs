...
{
    public sealed class CivicQuartetRenderingTests
    {
        ...
        [TestCase("Overworld.7.8.1")][TestCase("Overworld.13.7.1")][TestCase("Overworld.14.9.1")][TestCase("Overworld.10.14.1")]
        ...
        [TestCase("Overworld.7.8.0","GantryRegistryDesk")][TestCase("Overworld.7.8.0","GantryRegistrar")]
        [TestCase("Overworld.13.7.0","BoatFrame")][TestCase("Overworld.13.7.0","WaterPuddle")]
        [TestCase("Overworld.14.9.0","QuillholdArchiveShelf")][TestCase("Overworld.14.9.0","QuillholdArchiveWall")]
        [TestCase("Overworld.10.14.0","TentWall")][TestCase("Overworld.10.14.0","Crate")]
        ...
        { yield return "Overworld.7.8.0";yield return "Overworld.13.7.0";yield return "Overworld.14.9.0";yield return "Overworld.10.14.0"; }
    }
}
