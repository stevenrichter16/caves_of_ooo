...
{
    public sealed class WorkshopBogRenderingAdversarialTests
    {
        ...
        [TestCase("Overworld.6.6.0","ConcordFactor")]
        [TestCase("Overworld.6.6.0","Weaponsmith")]
        [TestCase("Overworld.15.6.0","PeatCutter")]
        ...
        {
            foreach(var id in WorkshopBogRenderingTests.Addresses())
            {
        ...
        [TestCase("Overworld.6.6.0","CinderholdNoticeBoard")]
        [TestCase("Overworld.6.6.0","TinkersForge")]
        [TestCase("Overworld.6.6.0","SmithAnvil")]
        [TestCase("Overworld.15.6.0","BoatFrame")]
        [TestCase("Overworld.15.6.0","TollRolls")]
        ...
        public void NativeDamageRemovesOnlyTheVictimsGeometry(string bp)
        {
            ...
            {
                f.Zone=new Zone("Overworld.15.6.0");f.Bind(f.Zone);f.Set("FullReveal",true);
