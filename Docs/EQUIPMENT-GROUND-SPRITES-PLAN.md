...
## R1 close-out — 18 September 2026

Seven16×16 bodies, ten exact aliases and missing-resource glyph fallback are accepted and promoted to local main. Existing32-case adversarial tests and final native67/67 pair pass. Root inspected actual normal/dim16px captures and enlarged art. Final75-second synthetic BEFORE/AFTER, raw metrics, known harness failures and retrospective-baseline scope divergence are documented in [R1 acceptance](RELEASE-R1-ACCEPTANCE.md). No general FPS or statistically proven performance claim.
