...
ap=argparse.ArgumentParser();ap.add_argument('--report',required=True);ap.add_argument('--out',required=True);ap.add_argument('--label',required=True);ap.add_argument('--stage-note',required=True);a=ap.parse_args()
