...
cmd=['/Applications/Unity/Hub/Editor/6000.3.4f1/Unity.app/Contents/MacOS/Unity','-projectPath',str(ROOT),'-executeMethod','CavesOfOoo.Editor.EmberAudioNativeAudit.RunFromCommandLine','-logFile',str(out/'unity.log')]
...
receipt={'exit':result.returncode,'compileErrors':errors,'cleanupCompleted':'[NativeSaveIsolation] Cleanup complete, exit=0' in log,'native':True}
